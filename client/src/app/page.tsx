  ...
  const downloadAsPdf = async () => {
    ...
    .then(function (blob) {
      ...
      const scale = Math.min(
        210 / element.offsetWidth, // A4 width in mm
        297 / element.offsetHeight // A4 height in mm
      );
      ...
      pdf.addImage(url, 'PNG', 0, 0, element.offsetWidth * scale, element.offsetHeight * scale);
